...
export default function UploadHistoryResearch({ refreshTrigger }) {
  ...
  const fetchLogs = useCallback(async () => {
    ...
    try {
      ...
      console.error("Failed to fetch research upload logs:", err);
      ...
      <div className="flex flex-col justify-between gap-4 border-b border-slate-200 px-5 py-5 sm:flex-row sm:items-center sm:px-7">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">
            Successful research dataset imports.
          </p>
        </div>
        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto">
          <button
            ...
            className="flex h-8 flex-1 items-center justify-center gap-1 rounded-md border border-[#580017]/20 bg-[#580017]/10 px-3 text-[11px] font-bold text-[#580017] transition-all hover:bg-[#580017]/20 disabled:opacity-50 sm:flex-none cursor-pointer"
          >
        ...
        <table className="w-full min-w-[680px] border-collapse text-left">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50 text-[10px] font-black uppercase tracking-wider text-slate-500">
              ...
              <th className="px-5 py-3.5">Records Ingested</th>
          ...
          <tbody className="divide-y divide-slate-100 text-xs text-slate-700">
            {loadingLogs ? (
              ...
              <tr>
                ...
                >
                  No successful research upload records found.
                </td>
              </tr>
            ) : (
